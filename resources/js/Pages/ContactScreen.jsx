    ...
    return (
        <div className="border border-gray-100 rounded-2xl overflow-hidden bg-white shadow-sm">
            ...
            >
                ...
                <span
                    className={`text-[#9333EA] text-lg shrink-0 transition-transform duration-200 ${open ? "rotate-180" : ""}`}
                >
                    ▾
                </span>
            </button>
...
const ContactScreen = () => {
    ...
    useEffect(() => {
        const el = document.getElementById("contact-scroll");
        if (!el) return;
    ...
    const faqs = [
        ...
        {
            q: "How can I reset a student's learning progress?",
            a: "Please contact our support team at hello@kiddo.test with your account details. We will process the request promptly.",
        },
        {
        ...
        {
            q: "Can Kiddo be used in a classroom setting?",
            a: "Absolutely. Kiddo is designed to complement classroom instruction. Teachers can recommend it as a home practice tool or integrate it directly into technology-assisted learning sessions.",
        },
    ];
    ...
    const navLinks = [
        ...
        { icon: "✉️", label: "Contact", path: "/contact", active: true },
    ];
        ...
        >
            ...
            >
                ...
                <section className="max-w-5xl mx-auto px-4 sm:px-6 pt-14 pb-10 text-center">
                    ...
                    >
                        For technical support, platform inquiries, or general
                        questions, our team is available and ready to assist
                        you.
                    </p>
                        ...
                        <div className="flex flex-col lg:flex-row gap-10 items-start">
                            ...
                            <div className="w-full lg:w-2/5 flex flex-col items-center text-center">
                                <div className="relative mb-6">
                                    <div className="absolute inset-0 bg-purple-100/50 blur-2xl rounded-full scale-75" />
                                    <img
                                        src="/assets/ui/mascot/fox-hint.png"
                                        alt="Kiddo"
                                        className="relative w-44 sm:w-52 object-contain drop-shadow-xl"
                                        onError={(e) => {
                                            e.currentTarget.src =
                                ...
                                <div className="bg-[#F3E8FF] rounded-3xl p-6 border-2 border-white shadow-sm max-w-sm w-full">
                                    <h3 className="font-black text-[#1E293B] text-sm mb-3">
                                        Contact Information
                                    </h3>
                                    <div className="space-y-3">
                                        <div className="bg-white rounded-2xl px-4 py-3 shadow-sm border border-purple-100 text-left">
                                            <p className="text-[11px] font-black text-[#94A3B8] uppercase tracking-wider mb-0.5">
                                                Email
                                            </p>
                                            <p className="font-black text-[#9333EA] text-sm">
                                                hello@kiddo.test
                                            </p>
                                        </div>
                                        <div className="bg-white rounded-2xl px-4 py-3 shadow-sm border border-purple-100 text-left">
                            ...
                            <div className="w-full lg:w-3/5">
                                <p className="text-[11px] font-black text-[#9333EA] uppercase tracking-[0.15em] mb-3">
                                    📋 Inquiry Types
                                </p>
                                <h2
                                    ...
                                    {[
                                        {
                                            ...
                                            desc: "Report a bug or technical issue and our team will investigate promptly.",
                                            color: "#FFE4E6",
                                            textColor: "#E11D48",
                                        },
                                        {
                                            ...
                                            desc: "Share suggestions or improvement ideas to help us enhance the platform.",
                                            color: "#FEF3C7",
                                            textColor: "#D97706",
                                        },
                                        {
                                            ...
                                            desc: "Questions about using Kiddo at home or integrating it into your classroom.",
                                            color: "#DCFCE7",
                                            textColor: "#16A34A",
                                        },
                                        {
                                            ...
                                            desc: "Interested in collaboration, licensing, or institutional use of the platform?",
                                            color: "#E0F2FE",
                                            textColor: "#0284C7",
                                        },
                                    ].map((item) => (
                                        <div
                                            key={item.title}
                                            className="rounded-2xl p-4 border-2 border-white shadow-sm hover:shadow-md hover:-translate-y-0.5 cursor-pointer transition-all duration-200"
                                            style={{ background: item.color }}
                                            onClick={() =>
                                                (window.location.href =
                                                    "mailto:hello@kiddo.test")
                                            }
                                        >
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div>
                                                    <p className="font-black text-[#1E293B] text-sm mb-1">
                                                        {item.title}
                                                    </p>
                                                    <p
                    ...
                    <div className="max-w-5xl mx-auto px-4 sm:px-6">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-[#64748B] font-semibold text-sm mt-2 max-w-sm mx-auto">
                                Can't find your answer below? Reach us directly
                                at hello@kiddo.test
                            </p>
                        </div>
