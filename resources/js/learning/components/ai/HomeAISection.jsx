...
const HomeAISection = () => (
    <section className="relative z-10 max-w-5xl mx-auto my-10 sm:my-16 px-4">
        <div className="bg-gradient-to-br from-purple-50 via-white to-pink-50 rounded-[2rem] border border-purple-100 shadow-xl p-6 sm:p-10 flex flex-col lg:flex-row items-center gap-6">
            <div className="w-28 h-28 sm:w-36 sm:h-36 rounded-full bg-gradient-to-br from-purple-200 to-pink-200 flex items-center justify-center shrink-0 shadow-inner border-4 border-white overflow-hidden">
                <img
                    src="/assets/ui/mascot/fox-main.png"
                    alt="Kiddo Fox Mascot"
                    className="w-full h-full object-contain p-2"
                    onError={(e) => { e.currentTarget.outerHTML = '<span class="text-6xl sm:text-7xl">🦊</span>'; }}
                />
            </div>
