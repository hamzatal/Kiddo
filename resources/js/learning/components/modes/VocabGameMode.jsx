...
const VocabGameMode = ({ lesson, deck = [], onComplete, promptText }) => {
    ...
    return (
        <div className="w-full max-w-3xl lg:max-w-4xl xl:max-w-5xl flex flex-col items-center gap-3 sm:gap-5 animate-fade-in-up px-2 sm:px-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-2 sm:gap-3 lg:gap-4 w-full max-w-lg sm:max-w-2xl lg:max-w-3xl xl:max-w-4xl mx-auto justify-items-center">
